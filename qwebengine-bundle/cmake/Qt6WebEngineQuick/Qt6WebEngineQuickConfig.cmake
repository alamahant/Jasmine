...
if (NOT QT_NO_CREATE_TARGETS AND Qt6WebEngineQuick_FOUND)
    ...
    if(NOT Qt6WebEngineQuick_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6WebEngineQuick_DEFINITIONS)
        ...
        endforeach()
        set(Qt6WebEngineQuick_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::WebEngineQuick)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
