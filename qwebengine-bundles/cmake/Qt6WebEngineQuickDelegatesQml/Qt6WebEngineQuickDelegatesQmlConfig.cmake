...
if (NOT QT_NO_CREATE_TARGETS AND Qt6WebEngineQuickDelegatesQml_FOUND)
    ...
    if(NOT Qt6WebEngineQuickDelegatesQml_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6WebEngineQuickDelegatesQml_DEFINITIONS)
        ...
        endforeach()
        set(Qt6WebEngineQuickDelegatesQml_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::WebEngineQuickDelegatesQml)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickDelegatesQmlVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
